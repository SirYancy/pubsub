...
bool_t *
joinserver_1(char *IP, int ProgID, int ProgVers,  CLIENT *clnt)
{
	joinserver_1_argument arg;
	static bool_t clnt_res;

	memset((char *)&clnt_res, 0, sizeof(clnt_res));
	arg.IP = IP;
	arg.ProgID = ProgID;
	arg.ProgVers = ProgVers;
	if (clnt_call (clnt, JoinServer, (xdrproc_t) xdr_joinserver_1_argument, (caddr_t) &arg,
...
bool_t *
leaveserver_1(char *IP, int ProgID, int ProgVers,  CLIENT *clnt)
{
	leaveserver_1_argument arg;
	static bool_t clnt_res;
	...
	arg.ProgID = ProgID;
	arg.ProgVers = ProgVers;
	if (clnt_call (clnt, LeaveServer, (xdrproc_t) xdr_leaveserver_1_argument, (caddr_t) &arg,
		(xdrproc_t) xdr_bool, (caddr_t) &clnt_res,
		TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
...
bool_t *
publishserver_1(char *Article, char *IP, int Port,  CLIENT *clnt)
{
	publishserver_1_argument arg;
	static bool_t clnt_res;
	...
	arg.IP = IP;
	arg.Port = Port;
	if (clnt_call (clnt, PublishServer, (xdrproc_t) xdr_publishserver_1_argument, (caddr_t) &arg,
		(xdrproc_t) xdr_bool, (caddr_t) &clnt_res,
		TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
